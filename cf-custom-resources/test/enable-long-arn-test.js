...
describe('Enable Long ARN Handler', () => {
    ...
    test('create operation', () => {
        ...
        // WHEN
        const lambda = LambdaTester(LongArnsLambda.handler)
            .event({
                RequestType: 'Create',
        ...
        lambda.expectResolve(() => {
            sinon.assert.calledWith(mockPutAccountSetting.firstCall, sinon.match({
                name: 'serviceLongArnFormat',
                value: 'enabled',
            }));
            sinon.assert.calledWith(mockPutAccountSetting.secondCall, sinon.match({
                name: 'taskLongArnFormat',
                value: 'enabled',
            }));
            sinon.assert.calledWith(mockPutAccountSetting.thirdCall, sinon.match({
