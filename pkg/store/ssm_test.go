...
func TestStore_ListProjects(t *testing.T) {
	...
	testProjectString, _ := marshal(testProject)

	cowProject := archer.Project{Name: "cow", Version: "1.0"}
	cowProjectString, _ := marshal(cowProject)
...
func TestStore_ListEnvironments(t *testing.T) {
	...
	testEnvironmentString, _ := marshal(testEnvironment)
	...
	prodEnvironmentString, _ := marshal(prodEnvironment)
