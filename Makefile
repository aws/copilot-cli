...
gen-mocks: tools
	...
	${GOBIN}/mockgen -package=mocks -destination=./internal/pkg/aws/applicationautoscaling/mocks/mock_applicationautoscaling.go -source=./internal/pkg/aws/applicationautoscaling/applicationautoscaling.go
