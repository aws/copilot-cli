...
type ECSAPI interface {
	...
	GetDeployment(*ecs.GetDeploymentInput) (*ecs.GetDeploymentOutput, error)
	GetDeploymentWithContext(aws.Context, *ecs.GetDeploymentInput, ...request.Option) (*ecs.GetDeploymentOutput, error)
	GetDeploymentRequest(*ecs.GetDeploymentInput) (*request.Request, *ecs.GetDeploymentOutput)
	...
	ListDeployments(*ecs.ListDeploymentsInput) (*ecs.ListDeploymentsOutput, error)
	ListDeploymentsWithContext(aws.Context, *ecs.ListDeploymentsInput, ...request.Option) (*ecs.ListDeploymentsOutput, error)
	ListDeploymentsRequest(*ecs.ListDeploymentsInput) (*request.Request, *ecs.ListDeploymentsOutput)
	...
	NotifyLifecycleHookComplete(*ecs.NotifyLifecycleHookCompleteInput) (*ecs.NotifyLifecycleHookCompleteOutput, error)
	NotifyLifecycleHookCompleteWithContext(aws.Context, *ecs.NotifyLifecycleHookCompleteInput, ...request.Option) (*ecs.NotifyLifecycleHookCompleteOutput, error)
	NotifyLifecycleHookCompleteRequest(*ecs.NotifyLifecycleHookCompleteInput) (*request.Request, *ecs.NotifyLifecycleHookCompleteOutput)
	...
	UpdateLifecycleHookExpiration(*ecs.UpdateLifecycleHookExpirationInput) (*ecs.UpdateLifecycleHookExpirationOutput, error)
	UpdateLifecycleHookExpirationWithContext(aws.Context, *ecs.UpdateLifecycleHookExpirationInput, ...request.Option) (*ecs.UpdateLifecycleHookExpirationOutput, error)
	UpdateLifecycleHookExpirationRequest(*ecs.UpdateLifecycleHookExpirationInput) (*request.Request, *ecs.UpdateLifecycleHookExpirationOutput)
