	...
	t.Run("validate application", func(t *testing.T) {
		...
		for name, tc := range testCases {
			t.Run(name, func(t *testing.T) {
				...
				in := overrideSvcVars{appName: tc.appName}
	...
	t.Run("validate environment name", func(t *testing.T) {
		...
		for name, tc := range testCases {
			t.Run(name, func(t *testing.T) {
				...
				in := overrideSvcVars{appName: "demo", envName: tc.envName, cdkLang: "typescript"}
				cmd := &overrideSvcOpts{overrideSvcVars: in}
				if tc.initMocks != nil {
					tc.initMocks(ctrl, cmd)
				}
	...
	t.Run("validate CDK language", func(t *testing.T) {
		...
		for name, tc := range testCases {
			t.Run(name, func(t *testing.T) {
				...
				in := overrideSvcVars{cdkLang: tc.lang, appName: "demo"}
				cmd := &overrideSvcOpts{
					overrideSvcVars: in,
					cfgStore:        mockSSM,
				}
	...
	t.Run("ask or validate service name", func(t *testing.T) {
		...
		for name, tc := range testCases {
			t.Run(name, func(t *testing.T) {
				...
				in := overrideSvcVars{name: tc.name, appName: "demo", iacTool: "cdk"}
				cmd := &overrideSvcOpts{
					overrideSvcVars: in,
	...
	t.Run("ask or validate IaC tool", func(t *testing.T) {
		...
		for name, tc := range testCases {
			t.Run(name, func(t *testing.T) {
				...
				in := overrideSvcVars{iacTool: tc.iacTool, name: "frontend", appName: "demo"}
				cmd := &overrideSvcOpts{
					overrideSvcVars: in,
					cfgStore:        mockSSM,
					ws:              mockWS,
...
`
		...
		for name, tc := range testCases {
			t.Run(name, func(t *testing.T) {
				...
				in := overrideSvcVars{iacTool: "cdk", name: "frontend", appName: "demo", skipResources: tc.skip}
				cmd := &overrideSvcOpts{
					overrideSvcVars: in,
					cfgStore:        mockSSM,
					ws:              mockWS,
	...
	t.Run("with the CDK", func(t *testing.T) {
		...
		for name, tc := range testCases {
			t.Run(name, func(t *testing.T) {
				...
				in := overrideSvcVars{iacTool: "cdk", name: "frontend", appName: "demo", resources: tc.resources}
				cmd := &overrideSvcOpts{
					overrideSvcVars: in,
				}
				tc.initMocks(ctrl, cmd)
