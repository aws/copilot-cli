...
Allows you to categorize resources.`
	...
	uploadResourcesFlagDescription = "Optional. Whether to upload dependency resources (e.g., image that needs to build and push), so that the output of `copilot svc package` can be directly used for deployment."
