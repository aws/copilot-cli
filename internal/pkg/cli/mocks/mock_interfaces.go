...
// MockappEnvStore is a mock of appEnvStore interface.
type MockappEnvStore struct {
	ctrl     *gomock.Controller
	recorder *MockappEnvStoreMockRecorder
}

// MockappEnvStoreMockRecorder is the mock recorder for MockappEnvStore.
type MockappEnvStoreMockRecorder struct {
	mock *MockappEnvStore
}

// NewMockappEnvStore creates a new mock instance.
func NewMockappEnvStore(ctrl *gomock.Controller) *MockappEnvStore {
	mock := &MockappEnvStore{ctrl: ctrl}
	mock.recorder = &MockappEnvStoreMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockappEnvStore) EXPECT() *MockappEnvStoreMockRecorder {
	return m.recorder
}

// CreateApplication mocks base method.
func (m *MockappEnvStore) CreateApplication(app *config.Application) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateApplication", app)
	ret0, _ := ret[0].(error)
	return ret0
...
// CreateApplication indicates an expected call of CreateApplication.
func (mr *MockappEnvStoreMockRecorder) CreateApplication(app interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateApplication", reflect.TypeOf((*MockappEnvStore)(nil).CreateApplication), app)
}

// CreateEnvironment mocks base method.
func (m *MockappEnvStore) CreateEnvironment(env *config.Environment) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateEnvironment", env)
	ret0, _ := ret[0].(error)
	return ret0
...
// CreateEnvironment indicates an expected call of CreateEnvironment.
func (mr *MockappEnvStoreMockRecorder) CreateEnvironment(env interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateEnvironment", reflect.TypeOf((*MockappEnvStore)(nil).CreateEnvironment), env)
}

// DeleteApplication mocks base method.
func (m *MockappEnvStore) DeleteApplication(name string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteApplication", name)
	ret0, _ := ret[0].(error)
	return ret0
...
// DeleteApplication indicates an expected call of DeleteApplication.
func (mr *MockappEnvStoreMockRecorder) DeleteApplication(name interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteApplication", reflect.TypeOf((*MockappEnvStore)(nil).DeleteApplication), name)
}

// DeleteEnvironment mocks base method.
func (m *MockappEnvStore) DeleteEnvironment(appName, environmentName string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteEnvironment", appName, environmentName)
	ret0, _ := ret[0].(error)
	return ret0
...
// DeleteEnvironment indicates an expected call of DeleteEnvironment.
func (mr *MockappEnvStoreMockRecorder) DeleteEnvironment(appName, environmentName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteEnvironment", reflect.TypeOf((*MockappEnvStore)(nil).DeleteEnvironment), appName, environmentName)
}

// GetApplication mocks base method.
func (m *MockappEnvStore) GetApplication(appName string) (*config.Application, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetApplication", appName)
	ret0, _ := ret[0].(*config.Application)
	ret1, _ := ret[1].(error)
...
// GetApplication indicates an expected call of GetApplication.
func (mr *MockappEnvStoreMockRecorder) GetApplication(appName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetApplication", reflect.TypeOf((*MockappEnvStore)(nil).GetApplication), appName)
}

// GetEnvironment mocks base method.
func (m *MockappEnvStore) GetEnvironment(appName, environmentName string) (*config.Environment, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEnvironment", appName, environmentName)
	ret0, _ := ret[0].(*config.Environment)
	ret1, _ := ret[1].(error)
...
// GetEnvironment indicates an expected call of GetEnvironment.
func (mr *MockappEnvStoreMockRecorder) GetEnvironment(appName, environmentName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetEnvironment", reflect.TypeOf((*MockappEnvStore)(nil).GetEnvironment), appName, environmentName)
}

// ListApplications mocks base method.
func (m *MockappEnvStore) ListApplications() ([]*config.Application, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListApplications")
	ret0, _ := ret[0].([]*config.Application)
	ret1, _ := ret[1].(error)
...
// ListApplications indicates an expected call of ListApplications.
func (mr *MockappEnvStoreMockRecorder) ListApplications() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListApplications", reflect.TypeOf((*MockappEnvStore)(nil).ListApplications))
}

// ListEnvironments mocks base method.
func (m *MockappEnvStore) ListEnvironments(appName string) ([]*config.Environment, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListEnvironments", appName)
	ret0, _ := ret[0].([]*config.Environment)
	ret1, _ := ret[1].(error)
...
// ListEnvironments indicates an expected call of ListEnvironments.
func (mr *MockappEnvStoreMockRecorder) ListEnvironments(appName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListEnvironments", reflect.TypeOf((*MockappEnvStore)(nil).ListEnvironments), appName)
}

// UpdateApplication mocks base method.
func (m *MockappEnvStore) UpdateApplication(app *config.Application) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateApplication", app)
	ret0, _ := ret[0].(error)
	return ret0
...
// UpdateApplication indicates an expected call of UpdateApplication.
func (mr *MockappEnvStoreMockRecorder) UpdateApplication(app interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateApplication", reflect.TypeOf((*MockappEnvStore)(nil).UpdateApplication), app)
}
...
func (mr *MockwsPipelineSelectorMockRecorder) Pipeline(prompt, help interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Pipeline", reflect.TypeOf((*MockwsPipelineSelector)(nil).Pipeline), prompt, help)
}
...
// UploadArtifacts mocks base method.
func (m *MockworkloadTemplateGenerator) UploadArtifacts() (*deploy.UploadArtifactsOutput, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UploadArtifacts")
	ret0, _ := ret[0].(*deploy.UploadArtifactsOutput)
	ret1, _ := ret[1].(error)
