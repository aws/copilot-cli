...
func (m *MockimageRepoEmptier) EmptyRepo(repo string, regions map[string]struct{}) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EmptyRepo", repo, regions)
	ret0, _ := ret[0].(error)
	return ret0
}

// EmptyRepo indicates an expected call of EmptyRepo.
func (mr *MockimageRepoEmptierMockRecorder) EmptyRepo(repo, regions interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EmptyRepo", reflect.TypeOf((*MockimageRepoEmptier)(nil).EmptyRepo), repo, regions)
}
