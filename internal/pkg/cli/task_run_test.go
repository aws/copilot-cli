...
func TestTaskRunOpts_Validate(t *testing.T) {
	testCases := map[string]struct {
		...
		"invalid platform": {
			...
			inOS:        "OStrich",
			inArch:      "MAD666",
			wantedError: errors.New("platform OSTRICH/MAD666 is invalid; valid platforms are: WINDOWS_SERVER_2019_CORE/X86_64, WINDOWS_SERVER_2019_CORE/ARM64, WINDOWS_SERVER_2019_FULL/X86_64, WINDOWS_SERVER_2019_FULL/ARM64, LINUX/X86_64 and LINUX/ARM64"),
		},
