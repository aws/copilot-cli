...
func TestTaskRunOpts_Validate(t *testing.T) {
	testCases := map[string]struct {
		...
		"invalid dockerfile path": {
			...
			wantedError: errors.New("invalid `--dockerfile` path: open " + filepath.FromSlash("world/hello/Dockerfile") + ": file does not exist"),
		},
		"invalid build context path": {
			...
			wantedError: errors.New("invalid `--build-context` path: open " + filepath.FromSlash("world/hello/Dockerfile") + ": file does not exist"),
		},
