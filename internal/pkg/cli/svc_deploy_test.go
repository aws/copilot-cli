  ...
  build:
	...
	tests := map[string]struct {
		...
		"should return error if platform is invalid": {
			...
			wantErr: errors.New("unmarshal service serviceA manifest: unmarshal to load balanced web service: validate platform: platform linus/abc123 is invalid; valid platforms are: linux/amd64, linux/x86_64, windows/amd64 and windows/x86_64"),
		},
