  ...
  port: 80`)
	...
	tests := map[string]struct {
		...
		"should return error if platform is invalid": {
			...
			wantErr: errors.New("validate manifest against environment : validate \"platform\": platform linus/abc123 is invalid; valid platforms are: linux/amd64, linux/x86_64, linux/arm, windows/amd64, windows/x86_64 and windows/arm"),
		},
