...
func (m *MockresourceGetter) GetResourcesByTags(resourceTypes []string, tags map[string]string) ([]*resourcegroups.Resource, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetResourcesByTags", resourceTypes, tags)
...
func (mr *MockresourceGetterMockRecorder) GetResourcesByTags(resourceTypes, tags interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetResourcesByTags", reflect.TypeOf((*MockresourceGetter)(nil).GetResourcesByTags), resourceTypes, tags)
}
