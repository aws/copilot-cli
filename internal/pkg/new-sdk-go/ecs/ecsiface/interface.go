...
// Package ecsiface provides an interface to enable mocking the Amazon Elastic Container Service service client
...
type ECSAPI interface {
	...
	DescribeFargateSpotPriceHistory(*ecs.DescribeFargateSpotPriceHistoryInput) (*ecs.DescribeFargateSpotPriceHistoryOutput, error)
	DescribeFargateSpotPriceHistoryWithContext(aws.Context, *ecs.DescribeFargateSpotPriceHistoryInput, ...request.Option) (*ecs.DescribeFargateSpotPriceHistoryOutput, error)
	DescribeFargateSpotPriceHistoryRequest(*ecs.DescribeFargateSpotPriceHistoryInput) (*request.Request, *ecs.DescribeFargateSpotPriceHistoryOutput)
