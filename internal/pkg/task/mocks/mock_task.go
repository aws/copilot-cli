...
func (m *MockRunner) DescribeTasks(cluster string, taskARNs []string) ([]*ecs.Task, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRunnerMockRecorder) DescribeTasks(cluster string, taskARNs []string) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DescribeTasks", reflect.TypeOf((*MockRunner)(nil).DescribeTasks), cluster, taskARNs)
}

// TaskDefinition mocks base method.
func (m *MockRunner) TaskDefinition(taskDefName string) (*ecs.TaskDefinition, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRunnerMockRecorder) TaskDefinition(taskDefName string) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TaskDefinition", reflect.TypeOf((*MockRunner)(nil).TaskDefinition), taskDefName)
}
...
func (mr *MockRunnerMockRecorder) CheckNonZeroExitCode(tasks []*ecs.Task) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckNonZeroExitCode", reflect.TypeOf((*MockRunner)(nil).CheckNonZeroExitCode), tasks)
}
