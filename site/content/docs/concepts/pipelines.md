...
Now that your `pipeline.yml`, `buildspec.yml`, and `.workspace` files have been created, add them to your repository. These files, all in your `copilot/` directory, are required for your pipeline's `build` stage to run successfully. 
