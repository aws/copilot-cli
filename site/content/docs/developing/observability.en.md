...
Examples are provided there for each language supported by OpenTelemetry.
You can also view documentation provided for AWS Distro for OpenTelemetry [here](https://aws-otel.github.io/docs/introduction).
...
Then, if you include the trace ID in your logs, they will show up along with the trace in CloudWatch.
