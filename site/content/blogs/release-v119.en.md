...
Copilot now exports private route table IDs from CloudFormation environment stacks. Use them to create VPC gateway endpoints with [addons](../../docs/developing/addons/workload). ([#3611](https://github.com/aws/copilot-cli/pull/3611))
